    ...
    return (
        <div ref={ref} style={receiptStyle}>
            ...
            <div style={sectionStyle1}>
                ...
                <Typography variant="body1" style={detailStyle}><strong>Name:</strong> {booking.propertyName}</Typography>
                <Typography variant="body1" style={detailStyle}><strong>Location:</strong> {booking.propertyLocation}</Typography>
